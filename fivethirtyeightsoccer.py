...
# hover tools
games.add_tools(HoverTool( mode='vline', tooltips=[("Date", "@tooltip"),("Odds", "@y{(0.00)}"),("Home-Away", "@home_away"),('Score', "@score"), ("Winner", "@winner"),("Return", "@winnings{$(0.00)}"),], names = ['red_game_bars', 'green_game_bars']))
