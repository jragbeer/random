...
df = pd.read_excel(path+"Staging Database Q1'19 v2 - shift.xlsm", sheet_name = 'OXF Database', skiprows = 4, usecols="C:GL", header = [0,2], skipfooter = 40)
df = cleandf(df)
...
# save to a CSV
df.to_csv(path+'feb5.csv',index_label = ['SPARTA Code', 'Year'],
