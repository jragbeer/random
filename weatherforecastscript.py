...
sched.add_job(gather_weather_forecasts, 'cron', minute=16, misfire_grace_time=60*5) #run the weather forecast ingest every half an hour
sched.add_job(copy_weather_forecast_to_azure, 'cron', minute=17, misfire_grace_time=60*10) #run the weather forecast ingest every half an hour
